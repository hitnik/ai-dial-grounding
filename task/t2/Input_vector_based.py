...
class UserRAG:
    ...
    async def _create_vectorstore_with_batching(self, documents: list[Document], batch_size: int = 100):
        ...
        for batch_vectorestore in batch_results:
            if batch_vectorestore is not None:
                if final_vectorstore is None:
                    final_vectorstore = batch_vectorestore
                else:
                    final_vectorstore.merge_from(batch_vectorestore)
